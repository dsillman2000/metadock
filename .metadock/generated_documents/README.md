...
| <code>html.details</code> | <code>metadock.env.MetadockHtmlNamespace.details: (self, *contents: str) -> str</code> | Wraps a string in HTML details tags (&lt;details&gt;&lt;/details&gt;). Multiple arguments get separated by two line breaks. <br/><pre><code class="language-py">&gt;&gt;&gt; from metadock.env import MetadockEnv<br />&gt;&gt;&gt; env = MetadockEnv().jinja_environment()<br />&gt;&gt;&gt; env.from_string(&quot;{{ html.details(&#x27;This is details text.&#x27;) }}&quot;).render()<br />&#x27;&lt;details&gt;\nThis is details text.\n&lt;/details&gt;&#x27;<br /></code></pre><br /> |
