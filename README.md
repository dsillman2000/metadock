...
| --- | --- | --- |
| <code>debug</code> | <code>metadock.env.MetadockEnv.debug: (self, message: str) -> None</code> | Prints a debug message to stdout, and returns an empty string.<br/><br/><pre><code>>>> from metadock.env import MetadockEnv<br/>>>> env = MetadockEnv().jinja_environment()<br/>>>> env.from_string("No changes!{{ debug('This is a debug message.') }}").render()<br/>This is a debug message.<br/>'No changes!'<br/></code></pre> |
